...
describe('Component Phone', () => {
  ...
  it(`TEST 29: should show Amanda phone number beetween 8-12 UTC`, () => {
  ...
  it(`TEST 30: should show Tobias phone number beetween 12-16 UTC`, () => {
  ...
  it(`TEST 31: should show Tobias phone number beetween 16-22 UTC`, () => {
  ...
  it(`TEST 32: should show Office is closed message`, () => {
